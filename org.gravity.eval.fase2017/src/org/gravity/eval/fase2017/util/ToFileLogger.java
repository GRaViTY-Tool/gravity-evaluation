package org.gravity.eval.fase2017.util;
	...
	public Statement apply(final Statement base, final Description description) {
		...
		return new Statement() {
			...
			public void evaluate() throws Throwable {
				...
				final Path target = ToFileLogger.this.path.resolve(String.format("%s.testlog."+System.currentTimeMillis()+".txt", correctTestName));
